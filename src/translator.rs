use std::{
    cell::RefCell, fmt::Display, hash::Hash, iter, path::Path, rc::Rc, str::FromStr, sync::LazyLock,
};
...
use crate::{
    ...
    database::dictionary_database::{
        DictionaryDatabase, DictionaryDatabaseTag, DictionarySet, GenericQueryRequest,
    ...
    dictionary::{
        ...
        InflectionSource, TermDefinition, TermDictionaryEntry, TermFrequency, TermHeadword,
...
impl Translator {
    ...
    /// # Arguments
    ///
    /// * sequence_list: `query_type` in [GenericQueryRequest] should be: [QueryRequestMatchType::Sequence]
    fn _add_related_dictionary_entries(
        ...
        let mut database_entries = self
            .db
            .find_terms_by_sequence_bulk(variant_to_generic_vec!(
                sequence_list,
